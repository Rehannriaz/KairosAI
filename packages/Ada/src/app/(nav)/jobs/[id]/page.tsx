    ...
    <section className="p-8">
      ...
      <div className="flex justify-center mt-8">
        <div className="w-[90%] space-y-8">
          ...
          <div>
          <h1 className="text-xl font-semibold mb-4 mt-10">Job Requirements</h1>
          {job.requirements ? (
            (() => {
              try {
                ...
                if (typeof parsedRequirements === "object" && parsedRequirements !== null) {
                  return Object.entries(parsedRequirements).map(([key, value]) => (
                ...
                return <p className="text-red-500">Error loading job requirements</p>;
              }
            })()
          ) : (
          ...
          <div className="mt-6">
            <Button type="primary" href={job.listingurl} target="_blank" size="large">
              Apply Now
            </Button>
          </div>
        </div>
